        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-4 md:gap-6 border-b border-slate-50 pb-8 md:pb-10">
          ...
          <div className="space-y-2 text-center md:text-left">
            ...
            <div className="flex items-center justify-center md:justify-start gap-4">
              <span className="text-slate-400 text-[9px] md:text-[10px] font-black tracking-widest uppercase">
                AI Profiling Synthesis
              </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-4 space-y-10">
            ...
            <div className="bg-[#FFFBEB] rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-8 border border-yellow-100/50">
              <h3 className="text-xs font-black text-slate-500 mb-4 md:mb-6 uppercase tracking-widest">
                Profile Summary
              </h3>
              <p className="text-slate-600 text-sm leading-loose font-medium">{result.summary}</p>
            </div>
          </div>
          ...
          <div className="lg:col-span-8 space-y-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-[#EFF6FF] rounded-[2rem] md:rounded-[3rem] p-6 md:p-8 border border-blue-100/50 shadow-sm">
              ...
              <div className="space-y-4">
                <p className="text-[10px] md:text-[11px] font-black text-blue-500 uppercase tracking-widest">
                  Work Style
                </p>
                <p className="text-slate-700 text-sm font-bold leading-relaxed">
                  {result.businessAptitude.workStyle}
                </p>
              </div>
              <div className="space-y-6">
                <div className="space-y-3">
                  <p className="text-[10px] md:text-[11px] font-black text-blue-400 uppercase tracking-widest">
                    Strengths
                  </p>
                  <div className="flex flex-wrap gap-2">
                    {result.businessAptitude.strengths.map((s, i) => (
                      <span
                        key={i}
                        className="px-3 py-1 bg-white text-slate-600 text-[10px] font-bold rounded-full border border-blue-50 shadow-sm"
                      >
                        {s}
                      </span>
                    ))}
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {result.businessAptitude.suitableRoles.map((r, i) => (
                      <span
                        key={i}
                        className="px-3 py-1 bg-blue-500 text-white text-[10px] font-bold rounded-full shadow-md shadow-blue-200"
                      >
                        {r}
                      </span>
                    ))}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-[#FDF2F8] rounded-[2rem] md:rounded-[3rem] p-6 md:p-8 border border-rose-100/50 shadow-sm">
              ...
              <div className="space-y-4">
                <p className="text-[10px] md:text-[11px] font-black text-rose-500 uppercase tracking-widest">
                  Social Style
                </p>
                <p className="text-slate-700 text-sm font-bold leading-relaxed">
                  {result.personCommunity.socialStyle}
                </p>
                <div className="pt-2">
                  <p className="text-[10px] md:text-[11px] font-black text-rose-400 uppercase tracking-widest mb-3">
                    Core Values
                  </p>
                  <ul className="space-y-2">
                    {result.personCommunity.values.map((v, i) => (
                      <li
                        key={i}
                        className="flex items-center gap-2 text-slate-600 text-[11px] font-medium italic"
                      >
              ...
              <div className="space-y-6">
                <div className="bg-white/60 p-5 rounded-2xl border border-rose-50 space-y-3">
                  ...
                  <p className="text-slate-600 text-[11px] font-medium leading-loose italic">
                    {result.personCommunity.interactionTips}
                  </p>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-700 text-xs font-black">
                      {result.personCommunity.optimalPlace}
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="px-8 py-4 glass rounded-[2rem] flex flex-col md:flex-row items-center gap-4 border border-white/60 shadow-xl">
          <div className="flex items-center gap-6">
            ...
            <span className="text-[10px] font-bold text-slate-500 italic">
              「Save for SNS」ボタンで生成された画像をシェアしよう！
            </span>
          </div>
        </div>
      </div>
